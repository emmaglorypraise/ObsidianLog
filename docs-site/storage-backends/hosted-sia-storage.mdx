...
you durable, redundant Sia storage with no indexer infrastructure to
operate.
...
is cryptographically unable to read your archived logs, regardless of
which backend or indexer you choose. See
