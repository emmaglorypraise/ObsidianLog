...
A fresh setup means exactly one keychain authorization prompt, whether you
choose the local or the Sia backend. On macOS this uses a direct,
"create only" keychain write rather than the usual check-then-write pattern
most tools use — see [ADR-0015](https://github.com/emmaglorypraise/ObsidianLog/blob/main/docs/adr/0015-bundled-credential-single-prompt-setup.md)
