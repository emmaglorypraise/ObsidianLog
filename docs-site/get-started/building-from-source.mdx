...
Building from a git clone gets you the latest, possibly-unreleased code,
useful if you're contributing or want a fix that hasn't shipped in a
release yet. Just want the last published version, without cloning
anything? See [Install with Cargo](/get-started/cargo-install).
