...
feature passed explicitly, since default builds/tests stay Sia-free (it
depends on a pre-1.0 SDK — see [ADR-0006](https://github.com/emmaglorypraise/ObsidianLog/blob/main/docs/adr/0006-sia-integration.md)):
